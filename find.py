...
"text-align:center;")
        ...
        self.find_input = QtWidgets.QLineEdit(self.frame)
        self.find_input.setGeometry(QtCore.QRect(360, 310, 420, 60))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        ...
        self.find_input.setStyleSheet("background-color:#5758BB;\n"
"color:white;\n"
"border: 2px solid white;\n"
"border-radius: 30px;")
        self.find_input.setAlignment(QtCore.Qt.AlignCenter)
        self.find_input.setObjectName("find_input")
        self.find_button = QtWidgets.QPushButton(self.frame)
        self.find_button.setGeometry(QtCore.QRect(490, 490, 151, 51))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        ...
        self.find_button.setStyleSheet("QPushButton{background-color:#5758BB;\n"
"color:white;\n"
"border-radius: 10px;}\n"
"QPushButton:pressed{\n"
