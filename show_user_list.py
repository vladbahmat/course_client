...
# Form implementation generated from reading ui file 'show_user_list.ui'
#
...
"text-align:center;")
        ...
        self.exit_from_clients_list = QtWidgets.QPushButton(self.frame)
        self.exit_from_clients_list.setGeometry(QtCore.QRect(500, 540, 151, 51))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.exit_from_clients_list.setFont(font)
        self.exit_from_clients_list.setStyleSheet("QPushButton{background-color:#5758BB;\n"
"color:white;\n"
"border-radius: 10px;}\n"
"QPushButton:pressed{\n"
...
"border-radius: 10px;\n"
"}")
        self.exit_from_clients_list.setObjectName("exit_from_clients_list")
        self.clients_list = QtWidgets.QPlainTextEdit(self.frame)
        self.clients_list.setGeometry(QtCore.QRect(0, 230, 1121, 301))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.exit_from_clients_list.setText(_translate("MainWindow", "Закрыть"))
