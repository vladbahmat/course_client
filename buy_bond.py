...
# Form implementation generated from reading ui file 'buy_bond.ui'
#
...
"text-align:center;")
        ...
        self.bond_button = QtWidgets.QPushButton(self.frame)
        self.bond_button.setGeometry(QtCore.QRect(490, 490, 151, 51))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.bond_button.setFont(font)
        self.bond_button.setStyleSheet("QPushButton{background-color:#5758BB;\n"
"color:white;\n"
"border-radius: 10px;}\n"
"QPushButton:pressed{\n"
...
"border-radius: 10px;\n"
"}")
        self.bond_button.setObjectName("bond_button")
        self.buy_bond = QtWidgets.QComboBox(self.frame)
        self.buy_bond.setGeometry(QtCore.QRect(260, 270, 591, 171))
        font = QtGui.QFont()
        font.setFamily("Tahoma")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.buy_bond.setStyleSheet("background-color:#5758BB;\n"
"color:white;\n"
"border-radius: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bond_button.setText(_translate("MainWindow", "Купить"))
